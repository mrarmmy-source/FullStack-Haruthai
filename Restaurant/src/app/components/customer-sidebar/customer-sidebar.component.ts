...
export class CustomerSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Reserve a Table', path: '/customer/reservations',
      icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { label: 'Booking History', path: '/customer/history',
  ...
  get userName(): string  { return this.supabase.currentUser?.full_name ?? 'Guest'; }
  get userPhone(): string { return this.supabase.currentUser?.phone_number ?? ''; }
